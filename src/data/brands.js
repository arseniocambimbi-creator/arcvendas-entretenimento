...
const BRANDS = [
  ...
  { key: 'unitv', match: /unitv|uni tv/i, name: 'UniTV', bg: 'linear-gradient(135deg, #0e2a52, #1f7fd0)', glyph: null },
  { key: 'youcine', match: /youcine|you cine/i, name: 'YouCine', bg: 'linear-gradient(135deg, #3a0f0f, #d81f26)', glyph: null },
];
